                         ...
                         required)   // true if required
{
 ...
 //     msg (infofield, "error", "ERROR: required");
     msg (infofield, "error", "obrigatório");  
      setfocus(valfield);
      return false;
    }
    else {
...
//    msg (infofield, "error", "ERROR: not a valid e-mail address");
    msg (infofield, "error", "email inválido");
    setfocus(valfield);
    return false;
  }
...
//    msg (infofield, "error", "ERROR: " + numdigits + " digits - too short");
    msg (infofield, "error", "" + numdigits + " digitos - muito pequeno");
    setfocus(valfield);
    return false;
  }
...
//    msg (infofield, "error", "ERROR: not a valid age");
    msg (infofield, "error", "idade inválida");
    setfocus(valfield);
    return false;
  }
...
//    msg (infofield, "warn", "Older than 110: check correct");
    msg (infofield, "warn", "mais velho do que 110: verifique");
  else {
    if (tfld<7) 
//      msg (infofield, "warn", "Bit young for this, aren't you?");
      msg (infofield, "warn", "demasiado novo, não?");
    else        
//      msg (infofield, "warn", "");
      msg (infofield, "warn", "");
  }
